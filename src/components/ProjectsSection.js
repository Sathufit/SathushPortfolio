...
export default function ProjectsSection() {
    ...
    return (_jsx("section", { ref: containerRef, id: "projects", className: "py-32 px-6", children: _jsx("div", { className: "max-w-6xl mx-auto", children: _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }, transition: { duration: 0.6 }, children: [_jsxs("div", { className: "mb-16", children: [_jsx("h2", { className: "text-3xl md:text-4xl font-bold text-zinc-50 mb-4", children: "Selected Work" }), _jsx("div", { className: "w-12 h-1 bg-zinc-50" })] }), _jsx("div", { className: "grid md:grid-cols-2 gap-8", children: projects.map((project, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }, transition: { duration: 0.6, delay: 0.1 * index }, whileHover: { y: -4 }, className: "group glass rounded-lg overflow-hidden hover:bg-zinc-800/50 transition-all duration-300 shine", children: [_jsxs("div", { className: "relative h-64 bg-zinc-900 overflow-hidden", children: [_jsx("img", { src: project.image, alt: project.title, className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105", onError: (e) => {
                                            ...
                                            } }), _jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors" })] }), _jsxs("div", { className: "p-6 space-y-4", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-xl font-semibold text-zinc-50 mb-2", children: project.title }), _jsx("p", { className: "text-zinc-400 text-sm leading-relaxed", children: project.description })] }), _jsx("div", { className: "flex flex-wrap gap-2", children: project.tech.map((tech, i) => (_jsx("span", { className: "px-3 py-1 bg-zinc-900/50 border border-zinc-700 rounded text-xs font-medium text-zinc-300", children: tech }, i))) }), _jsxs("div", { className: "flex items-center gap-4 pt-2", children: [project.url && (_jsxs("a", { href: project.url, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 text-sm font-medium text-zinc-50 hover:opacity-60 transition-opacity", children: ["View Live", _jsx(ExternalLink, { size: 16 })] })), _jsxs("a", { href: project.github, target: "_blank", rel: "noopener noreferrer", className: "inline-flex items-center gap-2 text-sm font-medium text-zinc-400 hover:text-zinc-50 transition-colors", children: ["Code", _jsx(Github, { size: 16 })] })] })] })] }, index))) })] }) }) }));
}
